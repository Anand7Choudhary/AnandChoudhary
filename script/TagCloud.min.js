! function (e, t) {
    ...
    var o = function () {
        function o() {
            ...
            i.$container = e, i.texts = t || [], i.config = r(r({}, o._defaultConfig), n || {}), i.radius = i.config.radius, i.depth = 1 * i.radius, i.size = 1.5 * i.radius, i.maxSpeed = o._getMaxSpeed(i.config.maxSpeed), i.initSpeed = o._getInitSpeed(i.config.initSpeed), i.direction = i.config.direction, i.keep = i.config.keep, i.paused = !1, i._createElment(), i._init(), o.list.push({
                el: i.$el,
                container: e,
                instance: i
            })
        ...
        return e = o, n = [{
            ...
            value: function () {
                ...
                // let screenWidth=window.innerWidth/2.5;
                // alert(screenWidth);
                ...
                // i.className = n.config.containerClass, n.config.useContainerInlineStyles, n.items = [], n.texts.forEach(function (e, t) {
            ...
            value: function () {
                ...
                if ('ontouchstart' in window || navigator.maxTouchPoints) {
                    o._on(n.$el, "touchstart", function (e) {
                        e = e || window.event;
                        var t = n.$el.getBoundingClientRect();
                        n.mouseX = (e.touches[0].clientX - (t.left + t.width / 2)) / 5;
                        n.mouseY = (e.touches[0].clientY - (t.top + t.height / 2)) / 5;
                        n.active = !0;
                    });
                    o._on(n.$el, "touchmove", function (e) {
                        e = e || window.event;
                        var t = n.$el.getBoundingClientRect();
                        n.mouseX = (e.touches[0].clientX - (t.left + t.width / 2)) / 5;
                        n.mouseY = (e.touches[0].clientY - (t.top + t.height / 2)) / 5;
                    });
                    o._on(n.$el, "touchend", function () {
                        n.active = !1;
                    });
                } else {
                    o._on(n.keep ? window : n.$el, "mousemove", function (e) {
            ...
            value: function () {
                var e, t, n, a, r = this;
                r.paused || (r.keep || r.active || (r.mouseX = Math.abs(r.mouseX - r.mouseX0) < 1 ? r.mouseX0 : (r.mouseX + r.mouseX0) / 2, r.mouseY = Math.abs(r.mouseY - r.mouseY0) < 1 ? r.mouseY0 : (r.mouseY + r.mouseY0) / 2), document.addEventListener('touchmove', function (event) {
                    r.mouseX = event.touches[0].clientX;
                    r.mouseY = event.touches[0].clientY;
                }, false), document.addEventListener('mousemove', function (event) {
                    r.mouseX = event.clientX;
                    r.mouseY = event.clientY;
                }, false), e = -(Math.min(Math.max(-r.mouseY, -r.size), r.size) / r.radius) * r.maxSpeed, t = Math.min(Math.max(-r.mouseX, -r.size), r.size) / r.radius * r.maxSpeed, Math.abs(e) <= .01 && Math.abs(t) <= .01 || (n = Math.PI / 180, a = [Math.sin(e * n), Math.cos(e * n), Math.sin(t * n), Math.cos(t * n)], r.items.forEach(function (e) {
                    var t = e.x,
                        n = e.y * a[1] + e.z * -a[0],
                        i = e.y * a[0] + e.z * a[1],
                        o = t * a[3] + i * a[2],
